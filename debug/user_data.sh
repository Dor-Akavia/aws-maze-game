...
# Write the HTML file directly (no heredoc issues)
cat > /var/www/maze-game/index.html << 'EOF'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <div class="controls">
            <button class="btn-control btn-up" onclick="move('up')">↑</button>
            <button class="btn-control btn-left" onclick="move('left')">←</button>
            <button class="btn-control btn-right" onclick="move('right')">→</button>
            <button class="btn-control btn-down" onclick="move('down')">↓</button>
        </div>
    </div>
    
    <div id="stageModal" class="modal">
        <div class="modal-content">
            <div class="modal-title">🎉 Stage Complete!</div>
            <p id="stageMsg"></p>
    ...
    <div id="gameModal" class="modal">
        <div class="modal-content">
            <div class="modal-title">🏆 You Win!</div>
            <p id="gameMsg"></p>
...
sed -i "s|__API_URL__|${api_gateway_url}|g" /var/www/maze-game/index.html

# Configure Nginx
cat > /etc/nginx/sites-available/maze-game << 'EOF'
server {
